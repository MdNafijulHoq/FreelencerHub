...
const UpdateJob = () => {
    ...
    const { _id, category, job_title, description, min_price, max_price, deadline} = job || {}
    ...
    const handleFormSubmission = async e => {
        ...
        const jobData = { job_title, deadline, category, 
         ...
         try{
            ...
            console.log(data)
            toast.success('Job Data Updated Successfuly!')
